...
DEFAULT_CONFIG = getattr(
    ...
    "TINYMCE_DEFAULT_CONFIG",
    {
        ...
        "code,help,wordcount, spellcheck,",
        "toolbar": " code | formatselect | undo redo |"
        "bold italic underline strikethrough | forecolor backcolor | link unlink anchor | image table media | alignleft aligncenter "
        "alignright alignjustify | bullist numlist outdent indent | "
        "removeformat | spellcheck | wordcount | "
        " print  | help | fullscreen | preview ",
        'width': '75%',
        'resize': "both",
